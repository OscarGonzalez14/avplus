      ...
      public function get_filas_venta(){
		...
		public function get_detalle_paciente($numero_venta){
           ...
           parent::set_names();
		      ...
		      $sql="select v.fecha_venta,v.numero_venta, v.paciente, v.cedula_paciente,v.total,c.id_paciente,c.cedula_paciente,c.nombre_paciente, c.apellido_paciente,c.telefono_paciente,c.correo_paciente,c.direccion_paciente,c.fecha_ingreso,c.estado
		      from ventas as v, pacientes as c
		      where 
		      
		      v.cedula_paciente=c.cedula_paciente
		      and
		      v.numero_venta=?
		...
		public function get_detalle_ventas_paciente($numero_venta){
           ...
           parent::set_names();
		      ...
		      $sql="select d.numero_venta,d.cedula_paciente,d.producto, d.moneda,d.precio_venta,d.cantidad_venta,d.descuento,d.importe,d.fecha_venta,v.numero_venta, v.moneda,v.subtotal, v.total_iva,v.total,c.id_paciente,c.cedula_paciente,c.nombre_paciente,c.apellido_paciente,c.telefono_paciente,c.correo_paciente,c.direccion_paciente,c.fecha_ingreso,c.estado
		      from detalle_ventas as d, ventas as v, pacientes as c
		      where 
		      
		      d.numero_venta = v.numero_venta
		      and 
		      d.cedula_paciente = c.cedula_paciente
		      and
		      d.numero_venta=?
 ...
 */
	...
	foreach ($detalles as $k => $v) {
		...
		//echo "Cant: ".$cantidad." codProd: ".$codProd. " Producto: ". $producto. " moneda: ".$moneda. " precio: ".$precio. " descuento: ".$dscto. " estado: ".$estado;
		   ...
		   $paciente_apellido = $_POST["apellido"];
    ...
    //estado 
        ...
        $sql->bindValue(1,$numero_venta);
        $sql->bindValue(2,$cedula_paciente);
        ...
        //$resultado=$sql->fetch(PDO::ASSOC);
          ...
          /*$sql2="insert into ventas 
           values(null,'".$fecha_venta."','".$numero_venta."','".$paciente_nombre."','".$cedula_paciente."');";*/
        ...
        //IMPORTANTE: hay que sacar la consulta INSERT INTO VENTAS fuera del foreach sino se repetiria el registro en la tabla ventas
           ...
           $sql2->bindValue(2,$paciente_nombre);
           $sql2->bindValue(3,$cedula_paciente);
