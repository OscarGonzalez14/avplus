             ...
             <div class="box-body">
                        ...
                        <table id="detalle_paciente" class="table table-striped table-bordered table-condensed table-hover">
                          ...
                          <tbody>
                            ...
                            <td> <h4 id="paciente"></h4><input type="hidden" name="paciente" id="paciente"></td>
                            <td><h4 id="numero_venta"></h4><input type="hidden" name="numero_venta" id="numero_venta"></td>
                            <td><h4 id="cedula_paciente"></h4><input type="hidden" name="cedula_paciente" id="cedula_paciente"></td>
