           ...
           <!--antes tenia un class="modal-content" y lo cambié por bg-warning para que tuviera fondo blanco, deberia haber sido un color naranja claro pero me salió un color blanco de casualidad--> 
            <div class="bg-info">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></i> Seleccione un Producto</h4>
              </div>
        ...
        <div class="table-responsive">
            ...
            <!-- /.box-body -->
             ...
             <div class="modal-footer">
                <button type="button" class="btn btn-blue pull-right" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i> Cerrar</button>
