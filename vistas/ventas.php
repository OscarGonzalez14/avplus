...
<!-- FIN DEL HEADER - LIBRERIAS -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Realizar Ventas de Productos a pacientes
    ...
    <div class="panel panel-default">
       ...
       <!--VISTA MODAL PARA AGREGAR paciente-->
    ...
    <!--FILA paciente - COMPROBANTE DE PAGO-->
     <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalpaciente"><i class="fa fa-search" aria-hidden="true"></i>  Buscar paciente</button>
                  </div>
            ...
            <input type="text" class="form-control" id="numero_venta" name="numero_venta" value="<?php $codigo=$venta->numero_venta();?>"  readonly>
               ...
               <div class="form-group">
                  <label for="" class="col-lg-3 control-label">DUI</label>

                  <div class="col-lg-9">
                    <input type="text" class="form-control" id="cedula" name="cedula" placeholder="DUI paciente" required pattern="[0-9]{0,15}" readonly>
                  </div>
              </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="table-responsive">
            <div class="box-header">
              <h3 class="box-title">Lista de Ventas a pacientes</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
